...
† Small-n families (n < 15). Per-family F1 results account for this imbalance; see paper Section VI.
...
| CNN1D | 87.75 ± 1.4% | 87.75 ± 1.4% | 87.60 ± 1.3% | 93.70 ± 1.6% |
...
> **Note:** The demo notebook loads from `dataset/sample_preview.csv`. To reproduce full results reported in the paper, refer to the complete pipeline described in the methodology section.
...
@article{Ferdous_2026_rande,
  ...
  year    = {2026},
  note    = {Upon request full dataset available at: https://drive.google.com/drive/folders/1lEmZYgFk43Md_K1tdinoCADX-3XHLIVt?usp=sharing }
}
```
